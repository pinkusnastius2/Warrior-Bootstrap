...
$Ammount = $_POST['Amount']; //Amount must be passed as an integer in pence
...
$ExpYear = $_POST['ExpYear']['2'].$_POST['ExpYear']['3'];
$CV2 = $_POST['CV2'];
...
<PaymentMessage>
<MerchantAuthentication MerchantID="'. trim(MODULE_PAYMENT_WORLDSAVEDIRECT_MERCHANTID) .'" Password="'. trim(MODULE_PAYMENT_WORLDSAVEDIRECT_PASSWORD) .'" />
<TransactionDetails Amount="'. $Ammount .'" CurrencyCode="'. $CurrencyCode .'">
...
$error = true;
        ...
        $messageStack->add_session('payment', $Response);
